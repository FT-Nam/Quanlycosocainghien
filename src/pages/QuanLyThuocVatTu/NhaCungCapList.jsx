...
const mockData = [
    { id: 1, maNCC: 'NCC001', tenNCC: 'Công ty Dược Hà Nội', trangThai: 'Đang hợp tác', moTa: 'Nhà cung cấp chính' },
    { id: 2, maNCC: 'NCC002', tenNCC: 'Công ty VTYT Bắc Ninh', trangThai: 'Ngừng hợp tác', moTa: 'Chuyên vật tư y tế' },
    // ... thêm dữ liệu mẫu
];
