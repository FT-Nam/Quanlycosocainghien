...
export default function GiaoDucDetail({ mode }) {
    ...
    useEffect(() => {
        if (!isNew && id) {
            ...
            setData({
                soChuongTrinhGiaoDuc: '2', soChuongTrinhTuVan: '1', tenChuongTrinhGiaoDuc: 'GDPL', thoiGianBatDauGD: '2023-01-01', thoiGianKetThucGD: '2023-03-01', diemTB: '8.5', xepLoai: 'Giỏi', giaoVien: 'Nguyễn Thị Lan', tenChuongTrinhTuVan: 'Tư vấn tâm lý', thoiGianBatDauTV: '2023-02-01', thoiGianKetThucTV: '2023-02-15', diemTBTuVan: '8.0', xepLoaiTuVan: 'Khá', giaoVienTuVan: 'Phạm Văn Dương', tongSoChuongTrinhNghe: '1', tongSoChungChi: '1', maLopHoc: 'L01', tenKhoaHoc: 'Tin học', loaiNganhNghe: 'CNTT', tenLopHoc: 'Lớp A', thoiGianBatDauNghe: '2023-04-01', thoiGianKetThucNghe: '2023-06-01', diemTBNghe: '8.2', xepLoaiNghe: 'Giỏi', tinhTrangChungChi: 'Đã cấp', maChungChi: 'CC01', tongSoLanLaoDong: '2', tenNoiLaoDong: 'Xưởng may', tongSoNgayCong: '30', tenChungChiLaoDong: 'Chứng chỉ A', thoiGianCapChungChi: '2023-07-01'
            });
        } else {
            setData(initData);
        }
